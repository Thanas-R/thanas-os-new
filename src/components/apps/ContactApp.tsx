      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-secondary rounded-xl p-6">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 p-3 bg-primary/10 rounded-lg hover:bg-primary/20 transition-colors col-span-2"
          >
            <ExternalLink className="w-5 h-5 text-primary" />
            <div className="flex flex-col items-start">
              <span className="text-sm font-medium text-primary">Portfolio Website</span>
              <span className="text-xs text-muted-foreground">thanas.vercel.app</span>
            </div>
          </a>
        </div>
      </div>

  ...
  const handleAppClick = (appId: string, index: number) => {
    if (iconRefs.current[index] && !settings.reducedMotion) {
      if (typeof window !== 'undefined' && window.gsap) {
        ...
        const bounceHeight =
          currentScales[index] > 1.3 ? -baseSize * 0.2 : -baseSize * 0.15;
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          boxShadow: `
            0 ${Math.max(4, baseSize * 0.1)}px ${Math.max(
            16,
            baseSize * 0.4
          )}px rgba(0, 0, 0, 0.4),
            0 ${Math.max(2, baseSize * 0.05)}px ${Math.max(
            8,
            baseSize * 0.2
          )}px rgba(0, 0, 0, 0.3),
      ...
      >
        ...
        >
                ...
                <div
                  ...
                  style={{
                    ...
                    filter: `drop-shadow(0 ${
                      scale > 1.2
                        ? Math.max(2, baseSize * 0.05)
                        : Math.max(1, baseSize * 0.03)
                    }px ${
                      scale > 1.2
                        ? Math.max(4, baseSize * 0.1)
                        : Math.max(2, baseSize * 0.06)
          ...
          <div
            ...
            onClick={() => {
              window.open('https://www.imdb.com/title/tt11448214/', '_blank');
            }}
            style={{

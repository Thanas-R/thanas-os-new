        ...
        <Card>
          ...
          <div className="px-6 pb-5 -mt-14 relative">
            ...
            <div className="mt-3 flex items-start justify-between gap-4">
             ...
             <div className="flex flex-col items-end gap-4 shrink-0 pt-1 ml-7">
  <div className="flex items-center gap-2 min-w-[220px]">
    <div className="w-7 h-7 flex items-center justify-center shrink-0 overflow-hidden rounded-[1.5px]">
      <img
        src={pesLogo}
        alt="PES University"

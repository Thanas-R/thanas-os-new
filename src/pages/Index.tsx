...
const apps: AppConfig[] = [
  ...
  { id: 'calendar', name: 'Calendar', icon: '📅', component: CalendarApp, defaultSize: { width: 1100, height: 750 }, chromeMode: 'integrated' },
  ...
  { id: 'github', name: 'GitHub', icon: '🐙', component: GitHubApp, defaultSize: { width: 1100, height: 750 }, chromeMode: 'integrated' },
